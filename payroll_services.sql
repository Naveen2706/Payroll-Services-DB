...
INSERT INTO payroll_service.employee_payroll (name, salary, gender, start) VALUES ('Rudra', 10000.12, 'M', '2021-05-29');
INSERT INTO payroll_service.employee_payroll (name, salary, Gender, start) VALUES ('Ashwini', 20000.12, 'F', '2021-03-03');
...
UPDATE payroll_service.employee_payroll SET Gender = 'M',  WHERE name = 'Ashwini';
UPDATE payroll_service.employee_payroll SET salary = 15000.00 WHERE Name = 'Ashwini';
